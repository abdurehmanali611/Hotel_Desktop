    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Row(
          ...
          children: [
            ClipRRect(borderRadius: BorderRadius.circular(90), child: Image(image: Image.network(widget.Logo).image, width: 50, height: 50, fit: BoxFit.cover)),
            const SizedBox(width: 10),
            Text("${widget.HotelName} Chef", style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold, fontFamily: "NotoSerif")),
          ],
        ),
        centerTitle: true,
      ),
        ...
        child: Query(
          ...
          builder: (QueryResult result, {VoidCallback? refetch, FetchMore? fetchMore}) {
            ...
            if (result.hasException) {
              return Center(child: Text("Error fetching data. Details: ${result.exception.toString().split(':')[0]}", style: const TextStyle(color: Colors.red, fontSize: 16), textAlign: TextAlign.center));
            }
            ...
            try {
              filteredItems = items.where((item) {
                return item['category'].toString().toLowerCase() == "food" && item['status'] == null && item['HotelName'] == widget.HotelName;
              });
            } catch (e) {
            ...
            return Mutation(
              ...
              builder: (RunMutation runMutation, QueryResult? result) {
                return LayoutBuilder(builder: (context, constraints) {
                  ...
                  final cardWidth = min(700.0, constraints.maxWidth * 0.9);
                            ...
                            children: [
                              ...
                              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                ElevatedButton(
                                  ...
                                  style: ElevatedButton.styleFrom(backgroundColor: const Color.fromARGB(255, 218, 70, 70), foregroundColor: Apptheme.buttontxt, padding: const EdgeInsets.symmetric(horizontal: 40, vertical: 15), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30)), elevation: 5),
